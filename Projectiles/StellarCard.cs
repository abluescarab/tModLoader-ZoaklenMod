...
{
	public class StellarCard : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Stellar Card");
		}
		...
		public override void AI()
		{
			...
			{
				int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 57, 0f, 0f, 100, default(Color), 1.5f);
		...
		public override bool PreKill(int timeLeft)
		{
			for(int i = 0; i < 10; i++)
			{
				...
				Main.dust[dust].velocity.X = (int)((projectile.velocity.X / 2f) + Main.rand.Next(-4, 5));
