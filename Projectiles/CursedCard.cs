...
{
	public class CursedCard : ModProjectile
	{
		public override void SetDefaults()
		{
			projectile.name = "Cursed Card";
		...
		public override bool PreAI()
		{
			...
			{
				int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 74, 0f, 0f, 100, default(Color), 2f);
		...
		public override bool PreKill(int timeLeft)
		{
			for(int i = 0; i < 10; i++)
			{
				int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 74, 0f, 0f, 100, default(Color), 1f);
