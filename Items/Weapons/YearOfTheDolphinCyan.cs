...
{
	public class YearOfTheDolphinCyan : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Year Of The Dolphin (Cyan)");
		...
		{
			int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, mod.ItemType("YearOfTheDolphinGreen"), 1, false, 0, false, false);
