...
{
	public class YearOfTheDolphinRed : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Year Of The Dolphin (Red)");
		...
		{
			int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, mod.ItemType("YearOfTheDolphinPurple"), 1, false, 0, false, false);
