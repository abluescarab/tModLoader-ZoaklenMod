...
{
	public class YearOfTheDolphinGreen : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Year Of The Dolphin (Green)");
		...
		{
			int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, mod.ItemType("YearOfTheDolphinBlue"), 1, false, 0, false, false);
