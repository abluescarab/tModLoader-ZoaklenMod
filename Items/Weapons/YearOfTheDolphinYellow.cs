...
{
	public class YearOfTheDolphinYellow : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Year Of The Dolphin (Yellow)");
		...
		{
			int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, mod.ItemType("YearOfTheDolphinCyan"), 1, false, 0, false, false);
